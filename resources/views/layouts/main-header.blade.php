				...
				<div class="container-fluid">
					<div class="main-header-left ">
						...
						<div class="main-header-center mr-3 d-sm-none d-md-none d-lg-block">
							<input class="form-control" placeholder="{{trans('dashboard.searchanything')}}" type="search"> <button class="btn"><i class="fas fa-search d-none d-md-block"></i></button>
						</div>
					</div>
								...
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
                                        <span class="avatar country-Flag mr-0 align-self-center bg-transparent">
                                            <img src="{{URL::asset('assets/img/flags/')}}/{{App::getLocale()}}-flag.png" class="img-flag">
                                        </span>
									</a>
									<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                           @if(App::getLocale() != $localeCode)
                                                <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" class="dropdown-item d-flex drop-img-flag">
                                                <span class="avatar  ml-3 align-self-center bg-transparent">
                                                    <img src="{{URL::asset('assets/img/flags/')}}/{{$localeCode}}-flag.png" alt="{{ $properties['native'] }}">
                                                </span>
                                                    <div class="d-flex title-flag">
                                                        {{ $properties['native'] }}
                                                    </div>
                                                </a>
                                            @endif
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									...
									<a class="dropdown-item" href=""><i class="bx bx-user-circle"></i>{{trans('dashboard.profile')}}</a>
									<a class="dropdown-item" href=""><i class="bx bx-cog"></i>{{trans('dashboard.editprofile')}}</a>
									<a class="dropdown-item" href=""><i class="bx bx-envelope"></i>{{trans('dashboard.messages')}}</a>
									<a class="dropdown-item" href=""><i class="bx bx-slider-alt"></i>{{trans('dashboard.accountsetting')}}</a>
